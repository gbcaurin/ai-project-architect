  ...
  if (isGenerating && !blueprint) {
    return (
      <div className="flex flex-col items-center justify-center h-64 gap-4">
        ...
        <p className="text-sm text-gray-500">Gerando seu blueprint…</p>
      </div>
    )
  }
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-4 sticky top-0 bg-[#0f0f1a] py-2">
        <span className="text-xs text-gray-600">Gerado em {new Date(blueprint.created_at).toLocaleString()}</span>
