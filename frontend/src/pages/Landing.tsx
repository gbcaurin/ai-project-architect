    ...
    <div className="min-h-screen bg-[#0a0a0f] flex flex-col">
      ...
      <nav className="flex items-center justify-between px-8 py-5 border-b border-white/5">
        <div className="flex items-center gap-2">
          ...
          <span className="text-white font-semibold text-sm tracking-tight">Arquiteto de Projetos IA</span>
        </div>
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-4 text-center pt-20 pb-32">
        ...
        <h1 className="text-5xl md:text-7xl font-bold text-white leading-tight mb-6 max-w-4xl">
          Seu software com IA
          <span className="bg-gradient-to-r from-indigo-400 to-purple-400 bg-clip-text text-transparent"> arquiteto</span>
        </h1>

        <p className="text-lg text-gray-400 max-w-xl mb-10 leading-relaxed">
          Pare de lutar com prompts vagos. Nossa IA faz uma entrevista sobre sua ideia
          e gera um blueprint técnico completo — otimizado para Claude Code,
          Cursor, Lovable e GPT.
        </p>
        ...
        <div className="flex flex-wrap gap-3 justify-center mt-16 max-w-2xl">
          {[
            ...
            '🏗️ Blueprint de arquitetura completo',
